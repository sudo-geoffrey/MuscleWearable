...
I am building a wearable that I will use at the gym to not only track reps, but give a **score for form** on new exercises using machine learning to detect bad habits and provide **alternatives** and **recommendations** to see which exercises activates your muscles the strongest
...
- Eventually: (XIAO ESP32 S3, Another EMG and IMU)
