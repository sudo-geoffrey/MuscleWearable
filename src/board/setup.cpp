...
void setupDisplay()
{
    ...
    esp_lcd_i80_bus_config_t bus_config = {
        ...
        .max_transfer_bytes =
            EXAMPLE_LCD_H_RES * 40 * sizeof(uint16_t)
    };
